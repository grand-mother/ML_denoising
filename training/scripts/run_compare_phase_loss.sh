#!/bin/bash
#SBATCH --job-name=phase_loss_cmp          # Job name
...
#SBATCH --time=14:00:00                    # 8 cells x 40 ep, sequential, ~100s/ep on 4-GPU DP
#SBATCH --output=phase_loss_cmp_%j.out     # Standard output and error log
...
OUT="$PROJECT_ROOT/raytune_lib_final/results/phase_loss_compare"
