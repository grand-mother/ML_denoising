#!/bin/bash
#SBATCH --job-name=dualae_multi_l1_1024   # Job name
#SBATCH --partition=gpu_v100             # Partition name
#SBATCH --time=48:00:00                    # Time limit hrs:min:sec
#SBATCH --output=dualae_multi_l1_1024_%j.out  # Standard output and error log
...
srun --partition=gpu_v100 python training/raytune_main_sept25.py \
    --json_params_file 'configs/experiments/training_params_multi_l1_100ep_24s_1024.json'
